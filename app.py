...
local_url = html.escape(os.getenv("LOCAL_BASE_URL", "http://localhost:1234/v1"))
local_ok = bool(discover_local_models(timeout=0.5))
...
with cols[2]:
    st.html(
        _status_card("Local", local_url, local_ok)
    )
